#!/usr/bin/env python3
#
# C64 control application
#
# Copyright (C) 2021 Sylvain Munaut
# SPDX-License-Identifier: MIT
#
# Modified to generate BSP_INPUT_SCANCODEs
...
PYGAME_TO_BSP = {
    # Letters
    pygame.K_a: BSPScancode.A,
    pygame.K_b: BSPScancode.B,
    pygame.K_c: BSPScancode.C,
    pygame.K_d: BSPScancode.D,
    pygame.K_e: BSPScancode.E,
    pygame.K_f: BSPScancode.F,
    pygame.K_g: BSPScancode.G,
    pygame.K_h: BSPScancode.H,
    pygame.K_i: BSPScancode.I,
    pygame.K_j: BSPScancode.J,
    pygame.K_k: BSPScancode.K,
    pygame.K_l: BSPScancode.L,
    pygame.K_m: BSPScancode.M,
    pygame.K_n: BSPScancode.N,
    pygame.K_o: BSPScancode.O,
    pygame.K_p: BSPScancode.P,
    pygame.K_q: BSPScancode.Q,
    pygame.K_r: BSPScancode.R,
    pygame.K_s: BSPScancode.S,
    pygame.K_t: BSPScancode.T,
    pygame.K_u: BSPScancode.U,
    pygame.K_v: BSPScancode.V,
    pygame.K_w: BSPScancode.W,
    pygame.K_x: BSPScancode.X,
    pygame.K_y: BSPScancode.Y,
    pygame.K_z: BSPScancode.Z,

    # Digits
    pygame.K_0: BSPScancode.KEY_0,
    pygame.K_1: BSPScancode.KEY_1,
    pygame.K_2: BSPScancode.KEY_2,
    pygame.K_3: BSPScancode.KEY_3,
    pygame.K_4: BSPScancode.KEY_4,
    pygame.K_5: BSPScancode.KEY_5,
    pygame.K_6: BSPScancode.KEY_6,
    pygame.K_7: BSPScancode.KEY_7,
    pygame.K_8: BSPScancode.KEY_8,
    pygame.K_9: BSPScancode.KEY_9,

    # Whitespace / control
    pygame.K_SPACE: BSPScancode.SPACE,
    pygame.K_RETURN: BSPScancode.ENTER,
    pygame.K_BACKSPACE: BSPScancode.BACKSPACE,
    pygame.K_TAB: BSPScancode.TAB,
    pygame.K_ESCAPE: BSPScancode.ESC,

    # Punctuation
    pygame.K_MINUS: BSPScancode.MINUS,
    pygame.K_EQUALS: BSPScancode.EQUAL,
    pygame.K_LEFTBRACKET: BSPScancode.LEFTBRACE,
    pygame.K_RIGHTBRACKET: BSPScancode.RIGHTBRACE,
    pygame.K_BACKSLASH: BSPScancode.BACKSLASH,
    pygame.K_SEMICOLON: BSPScancode.SEMICOLON,
    pygame.K_QUOTE: BSPScancode.APOSTROPHE,
    pygame.K_BACKQUOTE: BSPScancode.GRAVE,
    pygame.K_COMMA: BSPScancode.COMMA,
    pygame.K_PERIOD: BSPScancode.DOT,
    pygame.K_SLASH: BSPScancode.SLASH,

    # Modifiers
    pygame.K_LSHIFT: BSPScancode.LEFTSHIFT,
    pygame.K_RSHIFT: BSPScancode.RIGHTSHIFT,
    pygame.K_LCTRL: BSPScancode.LEFTCTRL,
    pygame.K_LALT: BSPScancode.LEFTALT,

    # Function keys
    pygame.K_F1: BSPScancode.F1,
    pygame.K_F2: BSPScancode.F2,
    pygame.K_F3: BSPScancode.F3,
    pygame.K_F4: BSPScancode.F4,
    pygame.K_F5: BSPScancode.F5,
    pygame.K_F6: BSPScancode.F6,
    pygame.K_F7: BSPScancode.F7,
    pygame.K_F8: BSPScancode.F8,
    pygame.K_F9: BSPScancode.F9,
    pygame.K_F10: BSPScancode.F10,
    pygame.K_F11: BSPScancode.F11,
    pygame.K_F12: BSPScancode.F12,

    # Keypad
    pygame.K_KP0: BSPScancode.KP0,
    pygame.K_KP1: BSPScancode.KP1,
    pygame.K_KP2: BSPScancode.KP2,
    pygame.K_KP3: BSPScancode.KP3,
    pygame.K_KP4: BSPScancode.KP4,
    pygame.K_KP5: BSPScancode.KP5,
    pygame.K_KP6: BSPScancode.KP6,
    pygame.K_KP7: BSPScancode.KP7,
    pygame.K_KP8: BSPScancode.KP8,
    pygame.K_KP9: BSPScancode.KP9,
    pygame.K_KP_PERIOD: BSPScancode.KPDOT,
    pygame.K_KP_MINUS: BSPScancode.KPMINUS,
    pygame.K_KP_PLUS: BSPScancode.KPPLUS,
    pygame.K_KP_MULTIPLY: BSPScancode.KPASTERISK,
}

def main(argv0, dev='/dev/ttyACM0'):
	...
	while running:
		...
		if event.type == pygame.QUIT:
			...
			kv = PYGAME_TO_BSP.get(event.key, BSPScancode.NONE)
			if (kv != BSPScancode.NONE) and (kv not in held):
				held.add(kv)
			...
			kv = PYGAME_TO_BSP.get(event.key, BSPScancode.NONE)
			if (kv != BSPScancode.NONE) and (kv in held):
				held.remove(kv)
